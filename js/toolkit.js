...
document.addEventListener("DOMContentLoaded", function () {
  ...
  toolButtons.forEach((button) => {
    button.addEventListener("click", () => {
      const toolType = button.parentElement
        .querySelector("h3")
...
function openSafetyQuiz() {
  const quizQuestions = [
    {
      question:
        "What should you do if your child receives a friend request from someone they don't know?",
      options: [
    ...
    {
      question:
        "Which of these is NOT a good practice for managing screen time?",
      options: [
