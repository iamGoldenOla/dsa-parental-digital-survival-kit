...
export default function ResourcesPage() {
  ...
  const resourceCategories = [
    {
      ...
      resources: [
        ...
        },
        {
          name: "Bark",
          description:
            "AI-powered monitoring for texts, emails, and social media.",
        ...
        },
        {
          name: "Qustodio",
          description:
            "Comprehensive parental control and screen time management.",
      ...
      resources: [
        {
          ...
          description:
            "Reviews and ratings for movies, TV shows, books, and games.",
        ...
        },
        {
          ...
          description:
            "Free educational games and activities for young children.",
  ...
  const currentAgeData =
    ageResources[activeAgeTab as keyof typeof ageResources];
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-text/80">
              Curated tools, apps, and platforms to help you protect and educate
              ...
              style={
                activeAgeTab === "early"
                  ? {
                      ...
                      boxShadow:
                        "0 10px 30px rgba(0, 0, 0, 0.1), 0 4px 10px rgba(0, 0, 0, 0.05), inset 0 1px 0 rgba(255, 255, 255, 0.8)",
            ...
            >
              <h3
                className={`text-2xl font-bold mb-6 ${
                  activeAgeTab === "early" ? "text-[#4B5D3E] text-left" : ""
                }`}
              >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {currentAgeData.resources.map((resource, index) => (
                  ...
                  >
                    <span
                      className={`text-2xl ${activeAgeTab === "early" ? "text-[#4B5D3E]" : ""}`}
                    >
                      {resource.icon}
                    </span>
                    <div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {category.resources.map((resource) => (
                  ...
                  >
                    ...
                    <p className="text-text/70 mb-4 text-left leading-relaxed">
      ...
      <section className="py-20 bg-background">
        <div className="container-custom text-center">
          ...
          <p className="text-lg text-text/80 mb-8 max-w-2xl mx-auto">
            Subscribe to our newsletter for the latest tools, tips, and updates
            in digital safety.
          </p>
