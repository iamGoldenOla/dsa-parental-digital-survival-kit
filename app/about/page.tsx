        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-text/80">
              Empowering parents with the tools and knowledge to navigate the digital world safely
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-text/80">
                To equip parents and caregivers with the tools, knowledge, and confidence needed to raise safe, 
                smart, and responsible digital citizens in a connected world.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h2 className="text-2xl font-bold mb-4">Our Vision</h2>
              <p className="text-text/80">
                To build a world where every parent feels empowered to navigate the digital landscape and 
                protect their children from online harm.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                description: 'We believe in empowering through knowledge and understanding.',
                icon: '📚'
              },
              {
              ...
              },
              {
                ...
                description: 'Supporting families in building healthy digital habits together.',
                icon: '👨‍👩‍👧‍👦'
              }
            ].map((value) => (
