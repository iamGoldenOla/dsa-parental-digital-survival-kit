        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-text/70 mb-12 max-w-2xl mx-auto">
              Comprehensive digital safety solutions tailored to your family's
              needs
            </p>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-text/70 max-w-3xl mx-auto">
              From free resources to personalized consultations, we offer
              multiple levels of support to help you navigate the digital world
              with confidence.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 transform hover:scale-105 transition-all duration-500 hover:shadow-2xl overflow-hidden">
              ...
              <div className="p-8">
                ...
                <p className="text-text/70 mb-6 leading-relaxed">
                  Access our comprehensive toolkit, guides, and educational
                  content at no cost to get started on your digital parenting
                  journey.
                </p>
                ...
                <a
                  href="/toolkit"
                  className="w-full bg-primary text-white py-3 px-6 rounded-xl font-semibold hover:bg-primary/90 transition-colors text-center block"
                >
                  Get Started Free
                </a>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl border-2 border-primary/20 transform hover:scale-105 transition-all duration-500 hover:shadow-2xl overflow-hidden relative">
              ...
              <div className="p-8">
                ...
                <p className="text-text/70 mb-6 leading-relaxed">
                  Join our supportive community of parents and access exclusive
                  resources, expert guidance, and peer support.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center text-text/80">
                    <svg
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 transform hover:scale-105 transition-all duration-500 hover:shadow-2xl overflow-hidden">
              ...
              <div className="p-8">
                ...
                <p className="text-text/70 mb-6 leading-relaxed">
                  Get personalized advice from our digital safety experts with
                  one-on-one sessions tailored to your family's needs.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center text-text/80">
                    <svg
        ...
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-text/70 mb-8">
              Choose the service that best fits your family's needs and start
              your digital safety journey today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/contact"
                className="bg-white text-primary border-2 border-primary px-8 py-3 rounded-xl font-semibold hover:bg-primary hover:text-white transition-colors"
              >
                Contact Us
              </a>
            </div>
